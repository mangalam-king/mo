...
async function load(){
 ...
 try{
  ...
  el.innerHTML=`<div class="cards">
   ...
   <div class="card"><div class="icon">🎫</div><h3>Admit Card</h3><p>View your examination details.</p><a class="btn primary" href="admit-card.html?id=${encodeURIComponent(r.id)}">Download Admit Card</a></div>
